...
NP_FIELD = ['Age', 'Annual Income', 'Number of Dependents', 'Previous Claims', 'Health Score', 'Premium Amount', 'Policy Start Date', 'nan_count']
TEST_NP_FIELD = ['Age', 'Annual Income', 'Number of Dependents', 'Previous Claims', 'Health Score', 'id', 'Policy Start Date', 'nan_count']
