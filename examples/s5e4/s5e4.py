...
API_KEY = "d372a01bd265e99ec5ef657da7ccec0e5e36494c"
...
def lgb_train(train_df, test_df: pd.DataFrame):
    ...
    wandb.init(project="s5e4", config={
        'rmse': 'rmse',
        'num_boost_round': 'num_boost_round'
    })
    wandb.log(data = {'rmse':7, 'num_boost_round':1})
    ...
    # bst = lgb.train(params, data, num_boost_round=500, valid_sets=[valid], categorical_feature=class_fields, callbacks=[lgb.early_stopping(50), lgb.log_evaluation(50), wandb.lightgbm.wandb_callback()])
